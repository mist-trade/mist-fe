# Capability: Workspace Layout and Navigation

The system SHALL enforce a unified institutional workbench layout and global top navigation across all frontend views.
